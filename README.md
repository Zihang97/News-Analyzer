...
As a journalist, I need to login to a secure service to upload my content

As a journalist, I have a number of PDF files that I want to upload to my account.

As a journalist, I want to search in all files I have uploaded.

As a journalist, I want to discover content from the WEB to enhance story

As a journalist, I want to know find the common keywords in subset of my documents.

As a journalist, I want to know all names, locations, institutions and address in my 
documents.

As a journalist, I want to know any relation between names, locations and institutions.

As a journalist, I want to find relationship between keywords in the ingested and discovered 
content.

As a journalist, I want to find sentiment (positive, negative or neutral) of different parts of the content

As a journalist, I want to modify the sentiment calculated by the system in case I disagree.

As a journalist, I want to search based on keywords and sentiments

As a journalist, I want the system to calculate similarities or correlation between key words 

As a journalist, I want to upload different types of files (CSV, DOC, etc.)
